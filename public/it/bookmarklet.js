...
var language_pack = {
	...
	'introtext' : "Benvenuto: puoi iniziare ad utilizzare YTLyrics inserendo nome dell'artista e della canzone e premendo il pulsante \"Ricerca Testo\"."
...
function initialization() {
    ...
    header_bookmarklet_div += '<div class="ytlinksbar"><div class="small" id="bookmarklet_yt_increasefont"><button class="close">+</button></div><div class="small notfirst" id="bookmarklet_yt_reducefont"><button class="close" style="margin-top:-3px">-</button></div><div class="small notfirst"><a href="https://www.facebook.com/pages/YTLyrics/425290784236106" target="_blank"><img src="' + localpath + 'resources/facebook-icon.png" style="height:16px;" /></a></div><div class="small notfirst"><a href="' + language_pack.localpath + 'it/ytlyrics.html#credits" target="_blank">' + language_pack.credits + '</a></div><div class="small notfirst" ><a href="' + language_pack.localpath + 'it/ytlyrics.html#new-features-and-bug-report" target="_blank">' + language_pack.suggestions + '</a></div><div class="small notfirst"><a href="' + language_pack.localpath + 'it/#new-features-and-bug-report" target="_blank">' + language_pack.reportbug + '</a></div></div>';
